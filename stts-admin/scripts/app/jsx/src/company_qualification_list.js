                        ...
                        <div className="sort-row overflow-hidden">
                            <div className="sort-inner">
                                <ul className="sorts">
                                    ...
                                    <li className="sort"><a href="#">审核申请时间</a></li>
            ...
            <div className="panel panel-default overflow-hidden">
                <div className="panel-body">
                    ...
                    <div id="moreConditionWrap" style={{display: "none"}}
                        ...
                        <div className="row">
                            <div className="form-group col-sm-4">
                                <label className="control-label col-sm-4">联系人</label>
                            ...
                            <div className="form-group col-sm-4">
                                <label className="control-label col-sm-5">审核申请时间</label>
    ...
    render: function () {
        return (
            <tr>
                ...
                <td>2016-02-12</td>
                <td>待审核</td>
                <td><a href="company_qualification.html">详情</a></td>
            </tr>
        );
    }
});
