    ...
    render: function () {
        return (
            <div className="order-process">
                ...
                <div className="node step">
                    <div><i className="icon fa fa-credit-card todo" aria-hidden="true"></i></div>
                    <div>完成并付款</div>
                ...
                <div className="node step">
                    <div><i className="icon fa fa-commenting todo" aria-hidden="true"></i></div>
                    <div>服务评价</div>
                    <div style={{display:"none"}}>2016-01-15</div>
                    <div style={{display:"none"}}>13:00:00</div>
                </div>
                <div className="node process">
                    <div className="arrow todo"></div>
                    <div></div>
