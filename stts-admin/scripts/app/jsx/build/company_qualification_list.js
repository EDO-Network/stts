                ...
                React.createElement("div", {className: "container"}, 
                    ...
                    React.createElement("div", {className: "ml-240"}, 
                        React.createElement("ol", {className: "breadcrumb"}, 
                            ...
                            React.createElement("li", {className: "active"}, "企业资质审核")
                        ), 
                        ...
                        React.createElement("div", {className: "sort-row overflow-hidden"}, 
                            React.createElement("div", {className: "sort-inner"}, 
                                React.createElement("ul", {className: "sorts"}, 
                                    ...
                                    React.createElement("li", {className: "sort"}, React.createElement("a", {href: "#"}, "审核申请时间")), 
                                    React.createElement("li", {className: "sort"}, React.createElement("a", {href: "#"}, "企业类型")), 
                                    React.createElement("li", {className: "sort"}, React.createElement("a", {href: "#"}, "交易次数")), 
                                    React.createElement("li", {className: "sort"}, React.createElement("a", {href: "#"}, "已使用服务券额")), 
                ...
                React.createElement("div", {className: "panel-body"}, 
                    ...
                    React.createElement("div", {id: "moreConditionWrap", style: {display: "none"}, 
                        ...
                        React.createElement("div", {className: "row"}, 
                            ...
                            React.createElement("div", {className: "form-group col-sm-4"}, 
                                React.createElement("label", {className: "control-label col-sm-4"}, "所在区域"), 
                        ...
                        React.createElement("div", {className: "row"}, 
                            React.createElement("div", {className: "form-group col-sm-4"}, 
                                React.createElement("label", {className: "control-label col-sm-4"}, "联系人"), 
                            ...
                            React.createElement("div", {className: "form-group col-sm-4"}, 
                                React.createElement("label", {className: "control-label col-sm-4"}, "联系电话"), 
                            ...
                            React.createElement("div", {className: "form-group col-sm-4"}, 
                                React.createElement("label", {className: "control-label col-sm-5"}, "审核申请时间"), 
        ...
        return (
            React.createElement("table", {className: "table table-hover"}, 
                ...
                React.createElement("tr", null, 
                    ...
                    React.createElement("th", null, "交易次数"), 
                    React.createElement("th", null, "已使用服务券额"), 
                    React.createElement("th", null, "所属区域"), 
                    React.createElement("th", null, "联系人"), 
                    React.createElement("th", null, "联系电话"), 
                    React.createElement("th", null, "审核申请时间"), 
    ...
    render: function () {
        return (
            React.createElement("tr", null, 
                ...
                React.createElement("td", null, "待审核"), 
                React.createElement("td", null, React.createElement("a", {href: "company_qualification.html"}, "详情"))
            )
        );
    }
});
