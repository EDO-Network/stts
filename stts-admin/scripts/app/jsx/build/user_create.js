                    ...
                    React.createElement("div", null, 
                        ...
                        React.createElement("div", {className: "ml-240"}, 
                            React.createElement("ol", {className: "breadcrumb"}, 
                                ...
                                React.createElement("li", {className: "active"}, "创建新用户")
                            ), 
                            React.createElement("div", {className: "panel panel-default"}, 
                                React.createElement("div", {className: "panel-heading"}, "创建新用户"), 
            ...
            React.createElement("div", null, 
                React.createElement("div", {className: "col-sm-6 form-horizontal"}, 
                        ...
                        React.createElement("div", {className: "col-sm-9"}, 
                            React.createElement("div", {className: "input-group"}, 
                                ...
                                React.createElement("span", {className: "input-group-btn"}, 
                                    React.createElement("button", {className: "btn btn-default", type: "button"}, "查找")
                                  )
                            )
                        )
                    ), 
                    ...
                    React.createElement("div", {className: "form-group text-center"}, 
                        React.createElement("button", {type: "button", className: "btn btn-primary"}, "提 交")
                    )
                ), 
...
ReactDOM.render(
    React.createElement(UserCreate, null),
