            ...
            React.createElement("div", {role: "tabpanel", className: "tab-pane active", id: "info"}, 
                React.createElement("div", {className: "row"}, 
                    React.createElement("div", {className: "col-sm-3"}, 
                        ...
                        React.createElement("button", {className: "col-sm-12 btn btn-default mt-20 "}, "展示标题图上传")
                    ), 
                    React.createElement("div", {className: "col-sm-9 form form-horizontal ", role: "form"}, 
                        ...
                        React.createElement("div", {className: "form-group"}, 
                            React.createElement("label", {className: "control-label col-sm-3"}, 
                                "服务大类", React.createElement("span", {className: "text-danger ml-5"}, "*")
                            ), 
                        ...
                        React.createElement("div", {className: "form-group"}, 
                            React.createElement("label", {className: "control-label col-sm-3"}, 
                                "服务小类", React.createElement("span", {className: "text-danger ml-5"}, "*")
                            ), 
                        ...
                        React.createElement("div", {className: "form-group form-inline"}, 
                            ...
                            React.createElement("div", {className: "col-sm-8"}, 
                                React.createElement("label", null, 
                                    React.createElement("input", {type: "radio", name: "optionsRadios", checked: true}), " 免费"
                                )
                            )
                        ), 
                        React.createElement("div", {className: "form-group form-inline"}, 
                            ...
                            React.createElement("div", {className: "col-sm-8"}, 
                                React.createElement("label", null, 
                                    React.createElement("input", {type: "radio", name: "optionsRadios"}), " 标品"
                                ), "      ", 
                        ...
                        React.createElement("div", {className: "form-group form-inline"}, 
                            ...
                            React.createElement("div", {className: "col-sm-8"}, 
                                React.createElement("label", null, 
                                    React.createElement("input", {type: "radio", name: "optionsRadios"}), " 非标品"
                                ), "  ", 

                                React.createElement("input", {type: "text", className: "form-control"}), 
                                React.createElement("label", {className: "text-center width-10"}, "~"), 
                                React.createElement("input", {type: "text", className: "form-control"})
                            )
                        ), 
                        ...
                        React.createElement("div", {className: "form-group"}, 
                            React.createElement("label", {className: "control-label col-sm-3"}, 
                                "合同模版", React.createElement("span", {className: "text-danger ml-5"}, "*")
                            ), 

                            React.createElement("div", {className: "col-sm-7"}, 
                                React.createElement("button", {className: "btn btn-default"}, "上 传"), 
                                "    ", React.createElement("a", {href: "#"}, "去云合同制作模板")
                            )
                        )
                    )
                ), 
            ...
            React.createElement("div", {role: "tabpanel", className: "tab-pane", id: "history"}, 
                React.createElement("div", {className: "col-sm-6"}, 
                    ...
                    React.createElement("button", {className: "btn btn-default btn-sm w-100"}, React.createElement("span", {
                        className: "fa fa-times-circle-o mr-10"}), "删除"
                    )
                ), 
                React.createElement("div", {className: "col-sm-6"}, 
                    React.createElement("button", {className: "btn badge-warning btn-sm w-100 mr-10"}, React.createElement("span", {
                        className: "fa fa-upload mr-10"}), "批量导入"
                    ), 
                ...
                React.createElement("div", {className: "mt-20 col-sm-12"}, 
                    React.createElement("table", {className: "table  table-hover"}, 
                        ...
                        React.createElement("tr", null, 
                            ...
                            React.createElement("td", {className: "text-danger"}, 
                            ...
                            React.createElement("div", {className: "form form-horizontal ", role: "form"}, 
                                ...
                                React.createElement("div", {className: "form-group"}, 
                                    ...
                                    React.createElement("div", {className: "col-sm-8 "}, 
                                        ...
                                        React.createElement("div", {className: "form-control-static text-danger"}, 
                                ...
                                React.createElement("div", {className: "form-group"}, 
                                    React.createElement("label", {className: "control-label col-sm-3"}, 
                                        "企业名称", React.createElement("span", {className: "text-danger ml-5"}, "*")
                                    ), 
                                    ...
                                    React.createElement("div", {className: "col-sm-8"}, 
                                        ...
                                        React.createElement("div", {className: "col-sm-4"}, 
                                            React.createElement("a", {href: "#", className: "btn"}, "搜 索")
                                        )
                                    )
                                )
                        ...
                        React.createElement("div", {className: "modal-footer "}, 
                            React.createElement("div", {className: "text-center"}, 
                                React.createElement("button", {type: "button", className: "btn btn-primary "}, 
                                    React.createElement("span", {className: "fa fa-save "}), " 提交"
                                ), 
