        ...
        return (
            React.createElement("div", null, 
                ...
                React.createElement("div", {className: "text-center mb-10"}, 
                    React.createElement("button", {className: "btn btn-default"}, "受理&签署合同"), "  ", 
                    React.createElement("button", {className: "btn btn-default"}, "拒绝"), "  ", 
                    React.createElement("button", {className: "btn btn-default"}, "同意退款/同意退单"), "  ", 
                    React.createElement("button", {className: "btn btn-default"}, "申请仲裁"), "  ", 
