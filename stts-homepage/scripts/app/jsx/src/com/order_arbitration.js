                    ...
                    <div>
                        ...
                        <div className="ml-240">
                            ...
                            <div className="panel panel-default">
                                <div className="panel-heading">退款退单详细</div>
        ...
        return (
            <div>
                ...
                <div className="text-center mb-10">
                    <button className="btn btn-default">退券</button>
                    &nbsp;&nbsp;
                    <button className="btn btn-default">退单</button>
                    &nbsp;&nbsp;
                    <button className="btn btn-default">撤消退款</button>
                    &nbsp;&nbsp;
