...
var OrderArbitrationDialog = React.createClass({
    render: function () {
        return (
            <div className="modal fade" id="orderArbitrationDialog" tabindex="-1" role="dialog" aria-labelledby="orderArbitrationDialogLabel"
                 aria-hidden="true">
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header">
                            ...
                            <h4 className="modal-title" id="orderArbitrationDialogLabel">仲裁申请</h4>
                        </div>
