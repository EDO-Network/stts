                    ...
                    <div>
                        <div className="pull-left w-222">
                            <div className="list-group">
                                <a href="password_reset_phone.html" className="list-group-item">通过手机重置密码</a>
                                <a href="password_reset_mail.html" className="list-group-item active">通过邮箱重置密码</a>
                            </div>
                        </div>
                        ...
                        <div className="ml-240">
                            <ol className="breadcrumb">
                                ...
                                <li className='active'>通过邮箱重置密码</li>
                            </ol>
                            <div className="panel panel-default">
                                <div className="panel-heading">通过邮箱重置密码</div>
                                    ...
                                    <div className="form-horizontal">
                                        <div className="form-group">
                                            ...
                                            <div className="col-sm-5">
                                                <input type="text" className="form-control" placeholder="请输入绑定的邮箱"/>
                                            </div>
                                        </div>
