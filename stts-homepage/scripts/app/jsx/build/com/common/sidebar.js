                    ...
                    React.createElement("ul", null, 
                        ...
                        React.createElement("li", null, 
                            ...
                            React.createElement("ul", {style: {display: 'none'}}, 
                                ...
                                React.createElement("li", null, 
                                    React.createElement("a", {id: "menuAdminsManage", href: SiteProperties.clientURL + Page.admins}, "站长管理")
                                ), 
                                React.createElement("li", null, 
                                    React.createElement("a", {id: "menuAccessManage", href: SiteProperties.clientURL + Page.access}, "API Access Key")
                                )
                            )
                        ), 
                        React.createElement("li", null, 
                            React.createElement("a", {id: "menuAccount", href: "javascript:void(0)", className: "has-sub", onClick: this.handleToggleSub}, 
                            ...
                            React.createElement("ul", {style: {display: 'none'}}, 
                                React.createElement("li", null, 
                                    React.createElement("a", {id: "menuProfile", href: SiteProperties.clientURL + Page.profile}, "个人信息")
                                ), 
                                React.createElement("li", null, 
                                    React.createElement("a", {id: "menuPassword", href: SiteProperties.clientURL + Page.password}, "密码修改")
                                )
                            )
                        )
                    )
