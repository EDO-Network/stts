        ...
        return (
            React.createElement("ul", {className: "nav navbar-nav"}, 
                React.createElement("li", {id: "mainMenuBussinessManage"}, 
                    React.createElement("a", {href: SiteProperties.webURL + Page.creditSearch}, "服务中心")
                ), 
                React.createElement("li", {id: "mainMenuBussinessManage"}, 
                    React.createElement("a", {href: SiteProperties.webURL + Page.creditSearch}, "订单管理")
                ), 
                React.createElement("li", {id: "mainMenuBussinessManage"}, 
                    React.createElement("a", {href: SiteProperties.webURL + Page.creditSearch}, "评论管理")
                ), 
                React.createElement("li", {id: "mainMenuBussinessManage"}, 
                    React.createElement("a", {href: SiteProperties.webURL + Page.creditSearch}, "机构设置")
                )
            )
        );
    }
